...
* [Viana et al., 'Sending fewer emails will not save the planet! An approach to make environmental impacts of ICT tangible for Canadian end users' (2002)](https://doi.org/10.1016/j.spc.2022.09.025) "Overall, the main sources of impacts are, in order of importance, the manufacture of electronic devices, the use of electronic devices, and viewing of video streaming. Some iconic digital activities, such as sending emails, contribute very little to a user's annual impact."
