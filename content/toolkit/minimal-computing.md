...
**Static site generators and minimal Content Management Systems**
...
## Tips for creating sustainable websites {#tips}
...
### Minify HTML and CSS or normalize space {#minify}
...
**Minimal design**. Specifying full minimal stack containers/machines.
...
Other categories to use to plan specific aspects of minimisation:
...
## Minimal computing, critical design, and system change {#system-change}
